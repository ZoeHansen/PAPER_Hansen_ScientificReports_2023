...
# Author: Zoe Hansen (modified from code generated by Karla Vasco)
...
args <- read.csv('D://Resistome/Reads_based/ERIN_GEnorm_ALL_TYPES_group_level_CaseFollowPairs.csv', header = TRUE)
...
taxonomy <- read.csv('D://Microbiome/Reads_based/GEnorm_ERIN_kaiju_60CaseFollowPairs_GENUS.csv', header=TRUE)
...
write_csv(nodes_gephi, 'D://CorrelationNetwork/Jan_2022_Global/FollowUp/nodes_GENUS_ARGgroup_FollowUp_cutoff12samples.csv')
...
write_csv(edges_group_clean, "D://CorrelationNetwork/Jan_2022_Global/FollowUp/edges_GENUS_ARGgroup_FollowUp_labels_80cutoff_50percTaxaARG.csv")

write_csv(edges_gephi, "D://CorrelationNetwork/Jan_2022_Global/FollowUp/edges_GENUS_ARGgroup_FollowUp_GEPHI_nolabels_80cutoff_50percTaxaARG.csv")

############ Beta-lactam Resistance Genes ###################

megares <- read.csv('D://megares_full_annotations_v2.csv', header=TRUE)
...
write.csv(pairs.final, 'D://CorrelationNetwork/Jan_2022_CaseFollowPairs_Betalactams/Betalactam_ARGs_Top10Pairs_viaCases_20220122.csv',
          row.names=FALSE)
...
# Case-Follow-Up pair information
pair.beta <- read.csv('D://CorrelationNetwork/Jan_2022_CaseFollowPairs_Betalactams/Betalactam_ARGs_AllCaseFollowPairs_20220123.csv',
                      header=TRUE)

# Same taxa code from above: 
# Normalized Actual abundance Taxonomic data
taxonomy <- read.csv('D://Microbiome/Reads_based/GEnorm_ERIN_kaiju_CaseControlFollow_GENUS.csv',
                     header=TRUE)
...
#Saving final file as csv
write_csv(nodes_pair_gephi, 'D://CorrelationNetwork/Jan_2022_CaseFollowPairs_Betalactams/All_CaseFollowPairs/nodes_GENUS_BETALACTAM_AllCaseFollowPairs_FOLLOWUPS_actualabundance_20220123.csv')
...
#Saving edges file as csv
write_csv(edges_group_pair_clean, "D://CorrelationNetwork/Jan_2022_CaseFollowPairs_Betalactams/All_CaseFollowPairs/edges_GENUS_BETALACTAM_AllCaseFollowPairs_FOLLOWUPS_labels_80cutoff_actualabundance_20220123.csv")
write_csv(edges_pair_gephi, "D://CorrelationNetwork/Jan_2022_CaseFollowPairs_Betalactams/All_CaseFollowPairs/edges_GENUS_BETALACTAM_AllCaseFollowPairs_FOLLOWUPS_GEPHI_nolabels_80cutoff_actualabundance_20220123.csv")
...
write.csv(beta_nodes, "D://CorrelationNetwork/Jan_2022_Betalactam/FollowUp/nodes_GENUS_BetalactamARGgroup_FollowUp_50percTaxaARG_20220126.csv",
          row.names=FALSE)
...
write.csv(beta.pair.edges, "D://CorrelationNetwork/Jan_2022_Betalactam/FollowUp/edges_GENUS_BETALACTAM_CONNECTIONS_FollowUp_labels_80cutoff_20220126.csv",
          row.names=FALSE)
write.csv(edges_beta_group_gephi, "D://CorrelationNetwork/Jan_2022_Betalactam/FollowUp/edges_GENUS_BETALACTAM_CONNECTIONS_FollowUp_GEPHI_nolabels_80cutoff_20220126.csv",
          row.names=FALSE)
...
### Campylobacter (repeat for Salmonella)
...
#Saving edges file as csv
write.csv(edges_group_clean, "D://CorrelationNetwork/Jan_2022_Global/Pathogen/Campylobacter/CASE_edges_GENUS_ARGgroup_Campylobacter_labels_80cutoff_50percTaxaARG_20220127.csv",
          row.names=FALSE)

write.csv(edges_gephi, "D://CorrelationNetwork/Jan_2022_Global/Pathogen/Campylobacter/CASE_edges_GENUS_ARGgroup_Campylobacter_GEPHI_nolabels_80cutoff_50percTaxaARG_20220127.csv",
          row.names=FALSE)
